...
function Props({ g, p }) {
  ...
  switch (g.prop) {
    ...
    case "tears":
      return (
        <g>
          <path className="bt-tear" transform="translate(166,246)" fill={p.accent} opacity=".9"
            d="M0,-11 Q7,-2 7,3 A7,7 0 1,1 -7,3 Q-7,-2 0,-11 Z" />
          <path className="bt-tear" transform="translate(254,246)" fill={p.accent} opacity=".9"
...
function ByteSVG({ p, glow, paused, waving, gesture, svgRef, eyeRef, parts = ALL_PARTS }) {
  ...
  return (
    ...
    >
      ...
      <g className="bt-float" transform={`translate(0,${lift})`}>
